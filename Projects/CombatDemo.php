...
<div class="content-wrap">
    <div class="content">
        ...
        <!--<div class="row" style="margin: .5em; text-align: center;">
            ...
            Throw in images of the console window, the wiki page, etc.
        ...
        <div class="row justify-content-center">
            <div class="card card-inverse">
                <a role="button" class="btn btn-outline-secondary" href="https://github.com/mjhehn/CombatDemo">See project</button>
            </div>
        </div>
    </div>
</div><!--content wrap-->
